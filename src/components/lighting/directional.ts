...
interface P { angle: number; elevation: number; wrap: number; rotateSpeed: number; animMode: AnimMode; }
...
const component: Component<P> = {
  ...
  create({ angle, elevation, wrap, rotateSpeed, animMode = AnimMode.OSCILLATE }) {
